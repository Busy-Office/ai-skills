...
const CLASSES = [
  ...
  ["record", /(LOOP-STATUS|LOOP-LOG|LOOP-METRICS|ORCHESTRATOR-STATE|RESUME|STATUS|STATE|INBOX|GATES?|HUMAN|LOG|HISTORY|JOURNAL|SESSION|CHANGELOG|MANUAL-ACTIONS|roundtable)/i],
